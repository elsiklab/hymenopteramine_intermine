...
public class PseudogeneEnsemblGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    PseudogeneEnsemblGffConverter converter;
    MockItemWriter itemWriter;

    public PseudogeneEnsemblGffConverterTest(String arg) {
        super(arg);
    }
