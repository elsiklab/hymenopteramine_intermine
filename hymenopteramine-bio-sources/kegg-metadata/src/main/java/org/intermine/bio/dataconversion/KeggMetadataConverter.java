    ...
    public void process(Reader reader) throws Exception {
        ...
        while (lineIter.hasNext()) {
            ...
            if (!identifier.isEmpty()) {
                ...
                throw new RuntimeException("identifier cannot be empty as it serves as a primaryIdentifier");
            }
            if (!pathwayClass.isEmpty()) {
                item.setAttribute("pathwayClass", pathwayClass);
            }
            if (!pathwayMap.isEmpty()) {
                item.setAttribute("pathwayMap", pathwayMap);
            }
            if (!koPathway.isEmpty()) {
                item.setAttribute("koPathway", koPathway);
            }
            ...
            try {
                ...
                System.out.println("Error while storing Pathway item: " + item + "\nStacktrace: " + e);
            }
        }
    }
