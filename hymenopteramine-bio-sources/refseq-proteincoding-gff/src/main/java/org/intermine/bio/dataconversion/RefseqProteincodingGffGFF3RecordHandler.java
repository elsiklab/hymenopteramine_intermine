...
{
    protected Map<String,String> aliasPrimaryIdentifierToDatabaseIdentifierMap = new HashMap<String,String>();
    protected Map<String,String> geneIdentifierToDatabaseIdentifierMap = new HashMap<String,String>();
   ...
   /**
    ...
    public void setCrossReference(String xRef) {
        ...
        if (!crossReferenceIdentifierToDatabaseIdentifierMap.containsKey(crossReferenceIdentifier)) {
           // Create a 'crossReference' item
            ...
            // keep track of this newly created 'crossReference' item
    ...
    public String parseGeneBiotype(String biotype) {
        ...
        if (biotype.equals("Mt_tRNA") || biotype.equals("Mt_rRNA") || biotype.equals("RNase_MRP_RNA") 
            ...
            || biotype.equals("V_segment") || biotype.equals("telomerase_RNA")) {
