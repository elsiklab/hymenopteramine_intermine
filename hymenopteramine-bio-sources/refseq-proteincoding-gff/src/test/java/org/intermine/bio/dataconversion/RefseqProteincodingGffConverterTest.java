...
public class RefseqProteincodingGffConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    RefseqProteincodingGffConverter converter;
    MockItemWriter itemWriter;

    public RefseqProteincodingGffConverterTest(String arg) {
        super(arg);
    }
