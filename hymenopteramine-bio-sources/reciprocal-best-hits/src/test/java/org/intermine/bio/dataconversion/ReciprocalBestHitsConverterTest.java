...
public class ReciprocalBestHitsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    ReciprocalBestHitsConverter converter;
    MockItemWriter itemWriter;

    public ReciprocalBestHitsConverterTest(String arg) {
        super(arg);
    }
