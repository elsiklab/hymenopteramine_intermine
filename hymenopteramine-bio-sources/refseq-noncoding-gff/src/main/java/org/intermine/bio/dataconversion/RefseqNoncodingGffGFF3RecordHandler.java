...
public class RefseqNoncodingGffGFF3RecordHandler extends GFF3RecordHandler
{
    ...
    /**
     * Method parses the xRef string, creates a Cross Reference item, creates a Gene item and sets the necessary references and collections
     * @param xRef
     */
    ...
    public String parseGeneBiotype(String biotype) {
        String returnType = "";
        if (biotype.equals("guide_RNA") || biotype.equals("antisense_RNA") || biotype.equals("Mt_tRNA") 
            || biotype.equals("Mt_rRNA") || biotype.equals("RNase_MRP_RNA") || biotype.equals("SRP_RNA") 
            || biotype.equals("misc_RNA") || biotype.equals("C_region") || biotype.equals("V_segment") 
            || biotype.equals("telomerase_RNA")) {
            returnType = biotype.replace("_", " ");
        } else if (biotype.equals("miRNA") || biotype.equals("ncRNA") || biotype.equals("RNase_P_RNA") 
            || biotype.equals("tRNA") || biotype.equals("rRNA") || biotype.equals("snRNA") 
            || biotype.equals("snoRNA") || biotype.equals("lncRNA")) {
            returnType = biotype;
